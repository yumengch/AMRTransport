...
def results(name_dir, name_log, name_vtu):
    os.chdir("/home/zmaw/u290235/code/src/idealized/interp/")
    ...
    file = 'AMRDUST.nc'
    shutil.move(os.path.join("/home/zmaw/u290235/code/src/idealized/interp/",file), os.path.join(name_dir,file))
